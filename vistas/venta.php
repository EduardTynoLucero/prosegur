...
<div class="box-header with-border">
  <h1 class="box-title">Envío<button class="btn btn-success" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i>Agregar</button></h1>
  ...
  <form action="" name="formulario" id="formulario" method="POST">
    <div class="form-group col-lg-8 col-md-8 col-xs-12">
     ...
     <div class="form-group col-lg-2 col-md-2 col-xs-6">
      ...
      <input class="form-control" type="text" name="serie_comprobante" id="serie_comprobante" maxlength="7" placeholder="Número Contenedor">
    </div>
     <div class="form-group col-lg-2 col-md-2 col-xs-6">
