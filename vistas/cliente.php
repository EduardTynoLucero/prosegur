...
<div class="box-header with-border">
  <h1 class="box-title">Lugar Envio <button class="btn btn-success" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i>Agregar</button></h1>
...
<div class="panel-body" style="height: 400px;" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="text" name="nombre" id="nombre" maxlength="100" placeholder="Destinatario" required>
    </div>
     <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Tipo Envío</label>
     <select class="form-control select-picker" name="tipo_documento" id="tipo_documento" required>
       <option value="PUNTO ENTREGA">Envío a un punto de entrega</option>
       <option value="URGENTE">Envío urgente</option>
       <option value="ESTANDAR">Envío estándar</option>
       <option value="REEMBOLSO">Envío contra reembolso</option>
       <option value="INTERNACIONAL">Envío internacional</option>
       <option value="FRAGIL">Envío frágil o pesado</option>
     </select>
    </div>
     <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Número Contenedor</label>
      <input class="form-control" type="text" name="num_documento" id="num_documento" maxlength="20" placeholder="Número de Contenedor">
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
